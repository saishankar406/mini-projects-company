...
const AttendanceCard = () => {
  ...
  const fetchLateLoginReasons = async () => {
    try {
      ...
      const response = await fetch(
        "http://40.192.64.65:8000/api/late-login-reasons/",
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const sendDailyReport = async (reportText) => {
    try {
      ...
      const response = await fetch(
        "http://40.192.64.65:8000/api/daily-work-reports/",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const fetchPunchRecords = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://40.192.64.65:8000/api/attendance/punch-records/${employeeId}/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
    ...
    const fetchPunchStatus = async () => {
      try {
        ...
        const profileResponse = await fetch(
          "http://40.192.64.65:8000/api/auth/me/",
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
  ...
  const punchIn = async (reason = "") => {
    try {
      ...
      const response = await fetch(
        `http://40.192.64.65:8000/api/attendance/punch-in/${employeeId}/`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const punchOut = async (reason = "") => {
    try {
      ...
      const response = await fetch(
        `http://40.192.64.65:8000/api/attendance/punch-out/${employeeId}/`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
        ...
        <Button
          ...
          onClick={async () => {
            try {
              ...
              const response = await fetch(
                `http://40.192.64.65:8000/api/attendance/admin-replies/${employeeId}/`,
                {
                  headers: {
                    "Content-Type": "application/json",
                    ...(token ? { Authorization: `Bearer ${token}` } : {}),
