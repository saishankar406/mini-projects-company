      ...
      <div className="flex flex-wrap justify-center py-20 md:hidden">
        <div className="w-full flex flex-wrap justify-center gap-4">
          {services.map((service, index) => (
            <div
              key={index}
              className={`group mb-8 w-[45%] gap-y-5 h-45 border border-[#C9C9C9] rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-primary hover:text-white transition-colors duration-300 p-3 card bounce-anim`}
            >
        ...
        <div className="w-full flex justify-center xl:gap-x-10 md:gap-x-5">
          {services.slice(0, 5).map((service, index) => {
            ...
            return (
              <div
                key={index}
                className={`group mx-4 gap-y-5 mb-8 w-45 h-45 border border-[#C9C9C9] rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-primary hover:text-white transition-colors duration-300 ${isAlternate ? 'translate-y-[-30px]' : ''} card bounce-anim`}
