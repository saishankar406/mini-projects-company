...
export default function StepsWeDO() {
  ...
  return (
    <div
      className="main_container md:h-screen md:flex md:items-center md:justify-center py-24 md:py-0"
      style={{
        overflowX: "hidden", // Prevents horizontal scroll on 110% zoom
        width: "100vw",       // Ensures layout doesn't exceed viewport
        maxWidth: "100%",     // Keeps everything within boundary
        boxSizing: "border-box",
      }}
    >
      <div className="md:max-w-8xl md:w-full md:mx-auto px-4">
        {/* Top container with header */}
        <div className="container" ref={headerRef} style={{ paddingTop: "40px" }}>
        ...
        {/* Step cards grid */}
        <div
          className="md:grid md:grid-cols-3 md:h-[500px] md:gap-8 my-10 container space-y-10 md:space-y-0 md:space-x-0"
          style={{
            overflowX: "hidden",         // Prevent horizontal cutoff
            maxWidth: "100%",            // Always contain the grid
          }}
        >
          <StepCard
            image={StepsImage1}
            ...
            items={["Initial Consultation", "Market Research", "Strategic Planning"]}
          ...
          <StepCard
            ...
            items={["Design Implementation", "Testing & Fixing", "Product Launch"]}
