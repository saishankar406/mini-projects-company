    ...
    <div className="container flex flex-col justify-center">
      <div className="mb-10">
        <h1 className="font xl:text-6xl md:text-5xl">
          Services offer for <span className="text-primary">AI & ML kk</span>
      ...
      <div className="flex flex-col md:flex-row gap-10 w-full my-20">
        <div className="w-full md:w-1/2 relative first-section">
          ...
          {services.map((service, index) => (
            <div
              ...
              className={
                `relative flex mb-10 pl-24 cursor-pointer service-item transition-transform duration-300` +
            ...
            >
              <div
                className={`absolute left-0 text-3xl font-medium transition-all duration-600 ${
                  activeIndex === index ? "scale-130 text-black" : "text-[#E6E6E6]"
                }`}
              >
                {service.number}
              </div>
              <div
                className="card-uiverse-bounce w-full"
                style={{ animationDelay: `${index * 0.25}s` }}
              >
                <div className="flex flex-col items-start">
                  <div className="w-8 h-8 mb-2 transition-transform duration-300">
                    <Image
                      src={service.icon}
                      alt="Service Icon"
                      width={32}
        ...
        <div
          className="w-full md:w-1/2 bg-cover bg-center bg-no-repeat rounded-lg relative overflow-hidden flex items-center justify-center p-8 min-h-[350px] hover:animate-pulse transition-all duration-300"
          style={{
            backgroundImage:
        ...
        >
          <div className="image-container">
            {services.map((service, index) => (
              <div
                key={index}
                className="image-wrapper card-uiverse-bounce"
                style={{ animationDelay: `${index * 0.25}s` }}
              >
                <Image
                  src={service.image}
            ...
            {services2.map((service, index) => (
              <div
                ...
                className={`image-wrapper ${
                  secondActiveIndex === index ? "active animate-bounce" : ""
                }`}
              >
                <Image
                  src={service.image}
        ...
        <div className="w-full md:w-1/2 relative second-section">
          ...
          {services2.map((service, index) => (
            <div
              ...
              className={`relative flex mb-10 pl-24 cursor-pointer service-item transition-transform duration-300 hover:animate-bounce ${
                secondActiveIndex === index ? 'animate-pulse' : ''
              }`}
              onMouseEnter={() => {
            ...
            >
              <div
                className={`absolute left-0 text-3xl font-medium transition-all duration-600 ${
                  secondActiveIndex === index
                    ? "scale-130 text-black animate-bounce"
                    : "text-[#E6E6E6]"
                }`}
              >
                {service.number}
              ...
              <div className="flex flex-col items-start">
                <div className={`w-8 h-8 mb-2 transition-transform duration-300 ${
                  secondActiveIndex === index ? 'animate-bounce' : ''
                }`}>
                  <Image
                    src={service.icon}
                    alt="Service Icon"
                ...
                <h3
                  className={`text-lg font-medium mb-1 transition-all duration-600 ${
                    secondActiveIndex === index ? "scale-110 text-primary animate-pulse" : ""
                  }`}
                >
                  {service.title}
                </h3>
        ...
        <div className="w-full md:w-1/2 relative third-section">
          ...
          {services3.map((service, index) => (
            <div
              ...
              className={`relative flex mb-10 pl-24 cursor-pointer service-item transition-transform duration-300 hover:animate-bounce ${
                thirdActiveIndex === index ? 'animate-pulse' : ''
              }`}
              onMouseEnter={() => {
            ...
            >
              ...
              <div className="flex flex-col items-start">
                <div className={`w-8 h-8 mb-2 transition-transform duration-300 ${
                  thirdActiveIndex === index ? 'animate-bounce' : ''
                }`}>
                  <Image
                    src={service.icon}
                    alt="Service Icon"
                ...
                <h3
                  className={`text-lg font-medium mb-1 transition-all duration-600 ${
                    thirdActiveIndex === index ? "scale-110 text-primary animate-pulse" : ""
                  }`}
                >
                  {service.title}
                </h3>
          ...
          <div className="image-container">
            {services3.map((service, index) => (
              <div
                key={index}
                className={`image-wrapper ${
                  thirdActiveIndex === index ? "active animate-bounce" : ""
                }`}
              >
                <Image
                  src={service.image}
